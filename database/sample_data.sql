...
INSERT OR IGNORE INTO users (id, username, email, password_hash, biography, created_at) VALUES
...
-- 插入範例留言
INSERT OR IGNORE INTO comments (id, user_id, post_id, content, created_at) VALUES
...
-- 更新序列值（SQLite 自動處理，但為了確保一致性）
UPDATE sqlite_sequence SET seq = 4 WHERE name = 'users';
UPDATE sqlite_sequence SET seq = 6 WHERE name = 'posts';
UPDATE sqlite_sequence SET seq = 10 WHERE name = 'comments';
